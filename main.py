...
def generate_html(members_list, heads_list, id_list):
    ...
    html_parts = [
        ...
        '    </style>',
        '    <script>',
        '       var thisStudionbPos = document.getElementsByClassName("studionb");',
        '       var thisStudioFlags = new Array();',
        '       thisStudioFlags[0] = "充满活力的";',
        '       thisStudioFlags[1] = "才华横溢的";',
        '       thisStudioFlags[2] = "勤奋努力的";',
        '       thisStudioFlags[3] = "坚韧不拔的";',
        '       thisStudioFlags[4] = "积极向上的";',
        '       thisStudioFlags[5] = "充满创意的";',
        '       var thisWhyAreLookingLonggggg = new Array();',
        '       thisWhyAreLookingLonggggg[0] = "你为什么要看这么久？？？";',
        '       thisWhyAreLookingLonggggg[1] = "你很无聊吗？？？";',
        '       thisWhyAreLookingLonggggg[2] = "？？？";',
        '       var thisNowPlayingFlags = 0;',
        '    </script>',
        '    </script>',
        '</head>',
        '<body>',
